...
echo "$($PSQL "select name from games full join teams on games.winner_id=teams.team_id or games.opponent_id=teams.team_id where year=2014 and round='Eighth-Final' order by name asc")"
